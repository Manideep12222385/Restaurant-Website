...
const Login = () => {
    ...
    // Set up an event listener to detect user activity
    const resetInactivityTimer = () => {
        if (inactivityTimer) {
            clearTimeout(inactivityTimer); // Clear previous timer
        }

        // Set a new timeout for automatic logout after 10 minutes of inactivity 1200000
        setInactivityTimer(setTimeout(autoLogout, 600000)); 
    };
                    ...
                    <button
                        ...
                        <svg className="w-5 h-5" viewBox="0 0 48 48" fill="none" xmlns="http://www.w3.org/2000/svg">
                            <g clipPath="url(#clip0_17_40)">
                                ...
                                <path d="M24.48 9.49932C27.9016 9.44641 31.2086 10.7339 33.6866 13.0973L40.5387 6.24523C36.2 2.17101 30.4414 -0.068932 24.48 0.00161733C15.4055 0.00161733 7.10718 5.11644 3.03296 13.2296L11.0051 19.4115C12.9187 13.6322 18.2275 9.49932 24.48 9.49932Z" fill="#EA4335" />
                            </g>
                            <defs>
